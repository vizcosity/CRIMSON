...
export default class AddPrimitiveIcon extends Component {
  ...
  <defs>
    ...
    <rect id="path-4" x={0} y={0} width={24} height={24} rx={5} />
      ...
      <g id="Floating-Toolbar-Concept-Mobile" transform="translate(1106.000000, 906.000000)">
        <g id="Controls" transform="translate(15.000000, 0.000000)">
          <g id="AddPrimitiveIcon" transform="translate(44.000000, 15.000000)">
            <use id="Selected-Object-Copy" strokeOpacity="0.176177536" stroke="#6D7173" mask="url(#mask-2)" strokeWidth={2} strokeDasharray={3} xlinkHref="#path-1" />
            <use id="Selected-Object-Copy-2" stroke="url(#linearGradient-3)" mask="url(#mask-5)" strokeWidth={2} strokeDasharray={3} xlinkHref="#path-4" />
            <g id="Shape" fillRule="nonzero">
              <use fill="#6D7173" fillRule="evenodd" xlinkHref="#path-6" />
