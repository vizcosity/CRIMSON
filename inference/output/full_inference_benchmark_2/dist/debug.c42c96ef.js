...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"debug.js":[function(require,module,exports) {
/**
...
function toggleBorders() {
  Array.from(document.getElementsByTagName('*')).forEach(function (element) {
    return element.classList.toggle('show-border');
  });
}

function toggleHidden() {
  Array.from(document.getElementsByClassName('meta')).forEach(function (label) {
    return label.classList.toggle('hidden');
  });
}
...
},{}]},{},["../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","debug.js"], null)
//# sourceMappingURL=/debug.c42c96ef.map